...
describe('LoginPage testCases', () => {
    it('should render typed username', () => {
        ...
        const { getByPlaceholderText } = render(<LoginPage username={username} onChangeUsername={()=>{}}/>);
    ...
    it('should render typed password', () => {
        ...
        const { getByPlaceholderText } = render(<LoginPage password={password} onChangePassword={()=>{}}/>);
    ...
    it('should render username Error', () => {
        ...
        const { getByText } = render(<LoginPage errroMessageUserName="Incorrect userName"/>);
        getByText(/Incorrect userName/i);
    });

    it('should render password Error', () => {

        const { getByText } = render(<LoginPage errorMessagePassword = "Incorrect password" />);
