...
describe("AdminService tests", () => {
    ...
    it('should test getUpdateWashingMachineSlotsDetails content', async() => {
        expect(await adminFixtureService.getUpdateWashingMachineSlotsDetails()).toBeDefined;
    ...
    it('should test postNewWashingMachineIdToAdd content', async() => {
        expect(await adminFixtureService.postNewWashingMachineIdToAdd()).toBeDefined;
    });
