...
describe('LoginPage testCases', () => {
    ...
    it('should render typed username', () => {
        ...
        const { getByPlaceholderText } = render(<SignUpPage username={username} onChangeUsername={()=>{}}/>);
    ...
    it('should render typed password', () => {
        ...
        const { getByPlaceholderText } = render(<SignUpPage password={password} onChangePassword={()=>{}}/>);
    ...
    it('should render typed confirmPassword', () => {
        ...
        const { getByPlaceholderText } = render(<SignUpPage confirmPassword={confirmPassword} onChangeConfirmPassword={()=>{}}/>);
