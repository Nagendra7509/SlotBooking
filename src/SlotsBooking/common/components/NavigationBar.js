      ...
      return (
         <NavBar>
            <TopPart>
               ...
               <NavItems>
                  <NavBarItem path={pathName} href={SLOTS_BOOKING_PATH}>
                     {Strings.navigationBar.home}
                  </NavBarItem>

                  <NavBarItem path={pathName} href={REQUEST_PAGE_PATH}>
                     {Strings.navigationBar.requests}
                  </NavBarItem>

                  <NavBarItem path={pathName} href={REPORTANISSUE_PAGE_PATH}>
                     {Strings.navigationBar.reportAnIssue}
                  </NavBarItem>

                  <NavBarItem path={pathName} href={PREVIOUS_SLOTS_PAGE_PATH}>
                     {Strings.navigationBar.previousSlots}
                  </NavBarItem>

                  <NavBarItem path={pathName} href={PROFILE_PAGE}>
            ...
            <BottomPart>
               <NavBarItem>
                  {Strings.navigationBar.numberOfSlotsMissed}:{0}
               </NavBarItem>
            </BottomPart>
         </NavBar>
      )
