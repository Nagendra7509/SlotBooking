...
describe("DashBoard tets", () => {
    ...
    it('should test DashBoard', async() => {
        ...
        await waitFor(() => {
            ...
            const dateFieldInUpComingSlot = getByRole('button', { name: "01-06-2020" })
            fireEvent.click(dateFieldInUpComingSlot);
            const dateFieldInAvailableSlots = getByRole('button', { name: "28-05-2020" });
            fireEvent.click(dateFieldInAvailableSlots);
            const timeBtnField = getByRole('button', { name: "05:00 AM - 06:00 AM" })
    ...
    it('should test upComing No booking yet Field', () => {
        ...
        waitFor(() => { getByText('No bookings yet') });
    })
