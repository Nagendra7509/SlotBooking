        ...
        return <PreviousSlotsContainer>
                    ...
                    <PreviousSlotsTableData>
                        {previousSlots.map(obj=><PreviousSlotsTableRow key={obj.date}>
                                                    <Typo14DarkBlueGreyHKGroteskRegular>{obj.date}</Typo14DarkBlueGreyHKGroteskRegular>
                                                    <Typo14DarkBlueGreyHKGroteskRegular>{obj.start_time+" - "+obj.end_time}</Typo14DarkBlueGreyHKGroteskRegular>
                                                    <Typo14DarkBlueGreyHKGroteskRegular>{obj.washing_machine_id}</Typo14DarkBlueGreyHKGroteskRegular>
                                                </PreviousSlotsTableRow>)}
                    </PreviousSlotsTableData>
                </PreviousSlotsContainer>
    }
