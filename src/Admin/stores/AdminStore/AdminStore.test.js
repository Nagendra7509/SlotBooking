...
describe('adminStore Tests', () => {
    ...
    it('should test onClickNewWashingMachine if Details are exist ', () => {
        ...
        expect(window.alert).toHaveBeenCalledWith('Already Exists Enter another number');
    ...
    it('should test onClickNewWashingMachine if enter nothing', () => {
        ...
        expect(window.alert).toHaveBeenCalledWith('please enter washing machine number');
    ...
    it('should test onClickActiveOrInactiveStatus fetching state', () => {
        ...
        expect(adminStore.getPostStatusOfWashingMachineResponseStatus).toBe(API_FETCHING);
